...
//
//public class ApplicationAdapter extends ApplicationAdapter.Adapter<ApplicationAdapter.MyViewHolder>{
//    Context context;
//
//
//
//
//    public ApplicationAdapter(Context context, ArrayList<Student> studentList){
